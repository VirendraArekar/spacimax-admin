            ...
            <Table sx={{ minWidth: 'auto' }} aria-label="custom pagination table" className="responsive-table">
                <TableHead >
                    <TableRow className="table-header">
                        ...
                        <TableCell align="center" component="th" className="t-cell">Action</TableCell>
                    </TableRow>
                </TableHead>
                <TableBody>
                    {
                        tips.map((item, index) => (
                            <TableRow key={index}>
                                ...
                                <TableCell align="left" className="t-body-cell">
                                    <Button  color="primary" variant="outlined" sx={{mx : 2, height : 50}} onClick={() => editClick(item.id)}>
                                      <EditIcon />
                                    </Button>

                                    <Button  color="error" variant="outlined" sx={{height : 50}} onClick={() => deleteClick(item.id)}>
                                      <DeleteIcon />
                                    </Button>
                                </TableCell>
                            </TableRow>
                    ...
                    <TableCell className="t-body-cell" direction="column" justifyContent="center">
                      <Link href="#" underline="none" >
                         ...
                         <div style={{
                            ...
                            <AddCircleIcon className="add-icon" fontSize="large" onClick={handleClickOpen}/>
                        </div>  
                      </Link>
                    </TableCell>
                    <TablePagination
